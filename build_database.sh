...
db_load -c dupsort=1 -T -t btree -f scores-final.txt sc.idx
db_load -c dupsort=1 -T -t btree -f pterms-final.txt pt.idx
db_load -c dupsort=1 -T -t btree -f rterms-final.txt rt.idx
