...
db_load -c duplicates=1 -f scores-final.txt -T -t btree sc.idx
db_load -c duplicates=1 -T -t btree -f pterms-final.txt pt.idx
db_load -c duplicates=1 -T -t btree -f rterms-final.txt rt.idx
